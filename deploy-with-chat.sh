...
LOCATION="uksouth"
DEPLOYMENT_NAME="expensemgmt-genai-$(date +%Y%m%d-%H%M%S)"
...
echo "Chat UI with GenAI: ${APP_SERVICE_URL}/chatui"
echo ""
echo "GenAI Services:"
...
echo ""
echo "You can now chat with your expenses using natural language!"
echo ""
